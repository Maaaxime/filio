                ...
                <div class="columns is-centered">
                    <div class="column">
                        <div class="control select  is-fullwidth">
                            {!! Form::select('report', $reportFilters['availableReports'], $reportFilters['selectedReport'], ['class' => '']) !!}
                        </div>
                    </div>
                    <div class="column">
                        <div class="control select  is-fullwidth">
                    ...
                    <div class="column is-narrow">
                        {!! Form::button('<span class="icon is-small"><i class="fa-solid fa-arrows-rotate"></i></span><span>' . __('message.refresh') . '</span>', ['class' => 'button is-primary  is-fullwidth', 'type' => 'submit']) !!}
                    </div>
                </div>
                {!! Form::close() !!}
            </div>
                ...
                <div class="columns">
                    ...
                    <div class="column is-one-thirds">
                        <div class="pb-6 sticky">
                            <ul
                                class="steps is-medium is-centered has-content-centered is-horizontal has-gaps">
                            ...
                            @foreach ($table as $type => $entries)
                                <section id="tab-{{ $type }}"
                                    ...
                                    <div class="table-container pr-2 pl-2">
                                        <table class="table is-striped is-hoverable is-fullwidth sortable-theme-minimal"
                                            data-sortable>
                                            <thead>
                                                <tr>
